...
app.config['MAIL_PASSWORD'] = 'buwzdtnepfqcezlk'  # Use your actual app password
app.config['MAIL_DEFAULT_SENDER'] = 'manoj@onwardhealth.co'

# Initialize Flask-Mail
mail = Mail(app)

WEBSITES = ['http://10.10.5.21:8080', 'http://10.10.5.21:9001']
...
def get_status():
    ...
    if websites_down:
        recipients = ['manoj@onwardhealth.co', 'manojchappidi999@gmail.com']
        ...
        print("All websites are up and running.")
